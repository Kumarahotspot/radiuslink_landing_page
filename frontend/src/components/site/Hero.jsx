...
export default function Hero() {
  ...
  return (
    <section id="home" data-testid="hero-section" className="relative pt-12 md:pt-16 pb-16 md:pb-24 overflow-hidden grain">
      {/* Background image */}
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 data-testid="hero-title" className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-black leading-[1.05] tracking-tight">
