          ...
          {t.features.list.map((f, i) => {
            ...
            return (
              <div
                ...
                className="group relative rounded-3xl border border-white/10 bg-card/40 p-7 hover:border-primary/30 hover:bg-card/60 transition-all duration-300 hover:-translate-y-1"
              >
