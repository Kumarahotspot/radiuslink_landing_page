...
export const translations = {
  id: {
    ...
    hero: {
      ...
      title_1: "Solusi RADIUS Billing",
      title_2: "Terpusat untuk ISP dan RT/RW Net",
  ...
  en: {
    ...
    hero: {
      ...
      title_1: "Centralized RADIUS Billing",
      title_2: "for ISPs and RT/RW Net",
      title_3: "across Indonesia.",
